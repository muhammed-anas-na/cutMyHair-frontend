'use client';
import { Facebook, Instagram, Twitter, LayoutDashboard, Calendar, Users } from "lucide-react";
                    ...
                    <div className="max-w-md w-full mx-auto">
                        <div className="mb-8">
                            <h1 className="font-bold text-3xl sm:text-4xl mb-3 text-gray-900">
                                {isOtpView ? "Verify your number" : "Salon Owner Login"}
                            </h1>
                            <p className="text-gray-600">
                                {isOtpView 
                                    ? "Enter the 4-digit code sent to your mobile number."
                                    : "Login to manage your salon, appointments, and client details."}
                            </p>
                        </div>
                            ...
                            <div className="space-y-5">
                                ...
                                <div className="text-center pt-2">
                                    <p className="text-gray-600">
                                        ...
                                        <Link href="/owner/register" className="text-[#CE145B] hover:underline font-medium">
                                            Register here
                                        </Link>
                                    </p>
                                </div>
