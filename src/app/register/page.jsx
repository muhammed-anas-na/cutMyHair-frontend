                    ...
                    <div className="max-w-md w-full mx-auto">
                        <div className="mb-8">
                            <h1 className="font-bold text-3xl sm:text-4xl mb-3 text-gray-900">
                                {isOtpView ? "Verify your number" : "Create account"}
                            </h1>
                            <p className="text-gray-600">
                                {isOtpView 
                                    ? "Enter the 4-digit code sent to your mobile number."
                                    : "Register to book salon services and manage your appointments."}
                            </p>
                        </div>
                            ...
                            <div className="space-y-5">
                                ...
                                <div className="text-center pt-2">
                                    <p className="text-gray-600">
                                        ...
                                        <Link href="/login" className="text-[#CE145B] hover:underline font-medium">
                                            Login here
                                        </Link>
                                    </p>
                                </div>
                                ...
                                <div className="relative my-6">
                                    ...
                                    <div className="relative flex justify-center text-sm">
                                        <span className="px-2 bg-gradient-to-br from-pink-50 to-[#F6D7D3] text-gray-500">
                                            Register to enjoy
                                        </span>
                                    </div>
                                </div>
